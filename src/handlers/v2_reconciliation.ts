...
/**
 * Opt-in only: set V2_RECONCILIATION_FROM_BLOCK to enable.
 * Factory onEvent + FactoryEventReconciliation (HyperSync PairCreated) already
 * cover V2 discovery; allPairs tip-state RPC was a third overlapping writer that
 * competed for archival RPC during catch-up.
 */
